<div class="row">
    ...
    <div class="col-lg-12 col-xlg-9">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Daftar SPTB</h4>
                            ...
                            <tr role="row">
                                ...
                                <td align="center">
                                    <?php if($this->session->userdata('level')=="pk"){?>
                                        <?php if($a->status_kg==11){ ?>
                                            <button class="btn waves-effect waves-light btn-success btn-sm" onclick="location.href='<?php echo base_url();?>index.php/c_pembayaran/tambah_pernyataan/<?php echo $a->id_rab;?>/<?php echo $a->id_kg;?>/<?php echo $a->lokasi_kg;?>'"><i class="mdi mdi-plus"></i>Tambah</button> 
                                        <?php }?>
                                    <?php }?>
                                    <?php if($a->status_kg>=12){ ?>
                                        <button class="btn waves-effect waves-light btn-info btn-sm" onclick="location.href='<?php echo base_url();?>index.php/c_pembayaran/rincian_pernyataan/<?php echo $a->id_rab;?>/<?php echo $a->id_kg;?>/<?php echo $a->lokasi_kg;?>'"><i class="mdi mdi-file-document"></i> Lihat</button>
                                    <?php }?>
                                </td>
                            </tr>
                        <?php $i++; }?>
