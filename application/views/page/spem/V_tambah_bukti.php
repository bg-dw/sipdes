    ...
    <div class="col-lg-12">
        <div class="card card-outline-info">
            <div class="card-header">
                <h4 class="m-b-0 text-white">Tambah Bukti Pencairan</h4>
            </div>
            <div class="card-body">
                <?php //var_dump($total_bp);?>
                <form action="<?php echo base_url();?>index.php/c_pembayaran/ac_input_bukti" method="POST">
                    <?php foreach($isi as $a){}?>
                    <input type="hidden" name="id_detail_kg" value="<?php echo $isi[0]->id_detail_kg;?>">
                    <input type="hidden" name="id_pj" value="<?php echo $isi[0]->id_pj;?>">
                    <input type="hidden" name="total_bp" id="total_bp" value="<?php echo $total_bp[0]->nomor+1;?>">
                    <div class="form-body">
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="nomor" required="" readonly="" id="inp_nomor">
                                    </div>
                                </div>
                            </div>
                        </div>
