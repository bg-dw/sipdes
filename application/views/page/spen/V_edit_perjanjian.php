    ...
    <div class="col-lg-12">
        <div class="card card-outline-info">
            <div class="card-header">
                <h4 class="m-b-0 text-white">Edit Perjanjian Kerjasama</h4>
            </div>
            <div class="card-body">
                <?php 
                //var_dump($total_pj);?>
                ...
                <form action="<?php echo base_url();?>index.php/c_penawaran/ac_edit_perjanjian" class="repeater form-horizontal" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="nomor" class="form-control" value="<?php echo $x->nomor_pj;?>" required="" readonly id="nomor">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-9">
                                <div class="form-group row">
                                    ...
                                    <div class="form-group row col-md-8">
                                        <div class="col-md-5">
                                            <input type="text" value="<?php echo date('m/d/Y',strtotime($x->tgl_mulai));?>" min="1" class="form-control mydatepicker" name="sejak_tgl" value="1" required="">
                                        </div>
                                        <div class="col-md-2">
                                            <label>Sampai</label>
                                        </div>
                                        <div class="col-md-5">
                                            <input type="text" value="<?php echo date('m/d/Y',strtotime($x->tgl_akhir));?>" min="1" class="form-control mydatepicker" name="sampai_tgl" value="1" required="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <textarea name="ketentuan" class="te1 form-control" rows="10" ><?php echo $x->ketentuan_pj;?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-9">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <textarea name="sanksi" class="te2 form-control" rows="10"><?php echo $x->sanksi_pj;?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
